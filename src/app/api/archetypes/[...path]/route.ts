...
function stylePlotHtml(html: string): string {
  ...
  return htmlWithControls
    ...
    .replaceAll('"margin":{"l":0,"r":0,"b":20,"t":30}', '"margin":{"l":0,"r":0,"b":0,"t":30}')
    .replaceAll('"margin":{"l":0,"r":0,"b":80,"t":30}', '"margin":{"l":0,"r":0,"b":0,"t":30}')
    .replaceAll('"legend":{"title":{"text":"Archetype"}}', '"showlegend":false,"legend":{"title":{"text":"Archetype"}}')
