...
const STADIUM_LOCATIONS: StadiumLocation[] = [
  ...
  { name: "Campbelltown Sports Stadium", latitude: -34.0497, longitude: 150.8332, aliases: ["campbelltown sports stadium", "campbelltown stadium", "orana park"] },
  ...
  { name: "Go Media Stadium", latitude: -36.9182, longitude: 174.8122, aliases: ["go media stadium", "mount smart stadium", "mt smart stadium", "one nz stadium"] },
